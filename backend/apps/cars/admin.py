...
class CarAdmin(admin.ModelAdmin):
    ...
    list_display = ('car_name', 'company','version', 'color', 'fuel_type', 'seat_capacity', 'transmission_type', 'total_km_driven')
...
class CarAdminUpdate(admin.ModelAdmin):
    ...
    list_display = ('id','car_name', 'company','version', 'color', 'fuel_type', 'seat_capacity', 'transmission_type', 'total_km_driven')
    search_fields = ('car_name', 'company', 'color')
    list_filter = ('fuel_type', 'transmission_type', 'seat_capacity')
...
class CarAdminDelete(admin.ModelAdmin):
    ...
    list_display = ('id','car_name', 'company', 'color', 'fuel_type', 'seat_capacity', 'transmission_type', 'total_km_driven')
    search_fields = ('car_name', 'company', 'color')
    list_filter = ('fuel_type', 'transmission_type', 'seat_capacity')
